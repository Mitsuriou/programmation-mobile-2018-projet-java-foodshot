...
public class ModelePublication {
    ...
    public ModelePublication(int id, String titre, String descImage, String URLimage, double latitude, double longitude,int nbLike, int id_utilisateur, String username, String URLprofil, String dateCreation) {
        this.id = id;
